    ...
    <div class="navscroll">
            <nav>
              ...
              <ul class="navlinks">
                ...
                <ul>
                  <li><a href="logina.php">Client</a></li>
...
<body>
  ...
  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="login-email">
			<p class="login-text" style="font-size: 2rem; font-weight: 800;">Login as Staff</p>
      <div class="input-group">
			...
			<p class="login-register-text">Don't have an account? <a href="loginu.php">Register Here</a>.</p>
		</form>
