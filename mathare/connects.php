...
if($_SERVER["REQUEST_METHOD"] == "POST"){
 ...
 $password_err="<div align='center' class='alert alert-danger'>
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO clients (username, password,telephone,address,town) VALUES (?, ?, ?, ?, ?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssss", $param_username, $param_password, $param_telephone, $param_town, $param_town);
 ...
 <div class="input-group">
   ...
   <div class="input-group">
		   ...
		   <?php  echo $msg;  ?>                            
		    ...
		    <p class="login-register-text">Have an account? <a href="logina.php">Login Here</a>.</p></div>     
